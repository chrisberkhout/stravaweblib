...
__all__ = [
    "WebClient", "ScrapingClient", "FrameType", "DataFormat", "ActivityFile",
    "ScrapedActivity", "ScrapedPhoto"
]
...
class ScrapingClient:
    ...
    def get_activity_data(self, activity_id, fmt=DataFormat.ORIGINAL, json_fmt=DataFormat.GPX):
        """
